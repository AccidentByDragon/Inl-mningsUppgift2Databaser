...
### API Examples:
  ...
  #### Example request from Locations, 
  using GET http://localhost:3000/api/locations/:id med en accepterad objektID,  Med en Status Kod 200:
